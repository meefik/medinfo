$(document).ready(function () {
    ...
    function phoneInit() {
        ...
        $("#report-form .medsys").click(function(){
            var q_gender = $("#report-form input[name='q_gender']").val();
            var q_age = $("#report-form input[name='q_age']").val();
    ...
    var questionnaire = {
        ...
        q_purpose: ["Вызов врача на дом", "Медицинская консультация", "Справочная информация", "Фармацефтическая информация"],
